...
- Technical lead for the development of the UNICEF Giga DataOps Platform: led a team of 5 data analytics and software
  ...
  near-real-time connectivity data for 93k schools updating every few minutes. The Platform was also being used by 2
  downstream applications with 5k monthly users.
