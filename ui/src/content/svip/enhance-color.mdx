...
courseSlug: "ap186"
created: "2019-08-26T03:00:37.0000Z"
...
<figure id="fig-enhance" class="container grid grid-cols-4 gap-4">
...
<figure id="fig-awbaet" class="container grid grid-cols-3 gap-4">
