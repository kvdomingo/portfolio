...
shape: "circle",
data: {
actual: { area: "502,655", error: 0, best: false },
spot: { area: "501,584", error: 0.21, best: false },
sobel: { area: "503,187", error: 0.11, best: false },
prewitt: { area: "503,187", error: 0.11, best: false },
laplacian: { area: "503,198", error: 0.11, best: false },
canny: { area: "503,182", error: 0.10, best: true },
}
},
{
shape: "square",
data: {
actual: { area: "640,000", error: 0, best: false },
spot: { area: "639,800", error: 0.03, best: true },
sobel: { area: "641,404", error: 0.22, best: false },
prewitt: { area: "641,404", error: 0.22, best: false },
laplacian: { area: "641,416", error: 0.22, best: false },
canny: { area: "641,398", error: 0.22, best: false },
}
},
{
shape: "trapezoid",
data: {
actual: { area: "426,667", error: 0, best: false },
spot: { area: "426,399", error: 0.06, best: true },
sobel: { area: "428,002", error: 0.31, best: false },
prewitt: { area: "428,002", error: 0.31, best: false },
laplacian: { area: "428,013", error: 0.32, best: false },
canny: { area: "427,731", error: 0.25, best: false },
}
},
{
shape: "triangle",
data: {
actual: { area: "320,000", error: 0, best: false },
spot: { area: "319,102", error: 0.28, best: false },
sobel: { area: "320,705", error: 0.22, best: false },
prewitt: { area: "320,705", error: 0.22, best: false },
laplacian: { area: "320,714", error: 0.22, best: false },
canny: { area: "320,304", error: 0.09, best: true },
}
},
]
...
<div id="fig-shapes" class="container mx-auto">
  <figure class="grid grid-cols-1 gap-4 md:grid-cols-4">
    {frontmatter.shapeData.map(image => (
      <figure>
        <img
    ...
    <figcaption class="figcaption col-span-4">
...
where `x_i`, `y_i` are the pixel coordinates,
and `N` is the number of pixels on the
...
<div id="fig-circles" class="container mx-auto">
  <figure class="grid grid-cols-1 gap-4 md:grid-cols-5">
    {frontmatter.algoData.map(image => (
      <figure>
        <img
          src={buildCldUrl(
    ...
    <figcaption class="figcaption col-span-5">
...
<table id="Table-areas" class="table table-lg">
  <caption>
    Table 2: Actual and calculated areas (px<sup>2</sup>) of each shape and
    their corresponding relative errors. The percentages in bold indicate the
    best-performing algorithm for each shape.
  </caption>
...
<div class="container mx-auto grid grid-cols-1 items-end gap-4 md:grid-cols-2">
  {frontmatter.detectData.map(data => (
    <figure>
