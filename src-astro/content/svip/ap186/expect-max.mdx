...
<figure id="fig-crushed" class="container">
  ...
  />
  <figcaption class="text-center">
    Figure 1: Estimated PDF in the $a^*$-$b^*$ feature space of bananas, apples,
    and oranges.
  </figcaption>
</figure>
...
<ol className="reference">
  <li id="Soriano2019">
    M. N. Soriano, _A15 - Expectation maximization_ (2019).
  </li>
  <li id="Chan2017">
    C. Chan, and J. McCarthy, [_Expectation maximization (EM)
    algorithm_](https://people.duke.edu/~ccc14/sta-663/EMAlgorithm.html) (2017).
  </li>
</ol>
