            ...
            <Container className='py-5' data-aos='fade-up'>
                <Row className='row-cols-1 row-cols-md-2'>
                    ...
                    <Col className='text-md-right my-auto'>
                        <Typography tag='h3' variant='h2-responsive' className='mb-3 section-header'>Video & Image Processing</Typography>
                        <p className='mb-3'>
                        ...
                        <Link to='/svip' className='mx-0 btn btn-outline-white mb-3 mb-md-0'>See portfolio</Link>
                    </Col>
                </Row>
            </Container>
        );
