        ...
        return (
            <Footer className='bg-dark pt-5'>
                <Container fluid className='text-center py-4'>
                    <Link to={`${this.props.urlPrefix}/`} className='d-block'>
                        <Image
                    ...
                    <a
                        href='mailto:hello@kvdomingo.xyz'
                ...
                <div className='footer-copyright text-center py-4'>
                    &copy; {(() => {let d = new Date(); return d.getFullYear()})()} <a href='mailto:hello@kvdomingo.xyz'>
                        Kenneth V. Domingo
                    </a>
                </div>
            </Footer>
