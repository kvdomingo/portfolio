...
export const generalSlice = createSlice({
  ...
  reducers: {
    updateHomeContent: (
      state,
      action: PayloadAction<DataLoadedState<HomeContent[]>>,
    ) => {
      state.home = action.payload;
    },
    updateHomeTechnologies: (
      state,
      action: PayloadAction<DataLoadedState<HomeTechnologies[]>>,
    ) => {
      state.technologies = action.payload;
    },
    updateAboutContent: (
      state,
      action: PayloadAction<DataLoadedState<AboutContent[]>>,
    ) => {
...
export const selectHomeTechnologies = (state: RootState) =>
  state.general.technologies;
