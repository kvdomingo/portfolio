...
<figure
  id="fig-function-fitter"
  class="container grid grid-cols-3 items-end gap-4"
>
...
<figure id="fig-fruit-decision3" class="container">
  ...
  />
  <figcaption class="text-center">
    Figure 4: Decision boundaries for bananas, apples, and oranges in $a^*-b^*$
    feature space.
  </figcaption>
</figure>
