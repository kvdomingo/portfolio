...
<figure class="figure" id="fig:radial-profile">
  <Image publicId="svip/186/2-Practical2/graph-image" />
...
<figure class="figure" id="fig:calibration">
  <Image publicId="svip/186/2-Practical2/calibration_curves" />
...
<figure class="figure" id="fig:fit">
  <Image publicId="svip/186/2-Practical2/final_overlay" />
  <figcaption class="text-center">
