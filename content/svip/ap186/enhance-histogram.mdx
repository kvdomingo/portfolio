...
<figure
  id="fig-enhance"
  class="container grid grid-cols-2 gap-4 lg:grid-cols-4"
>
  ...
  <figcaption class="col-span-2 text-center lg:col-span-4">
...
<figure
  id="fig-crushed"
  class="container grid grid-cols-1 items-end gap-4 lg:grid-cols-3"
>
  ...
  <figcaption class="text-center lg:col-span-3">
