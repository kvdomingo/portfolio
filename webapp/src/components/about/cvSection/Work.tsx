...
function Work() {
  ...
  return (
    <TimelineSection name="Work" icon={<BusinessCenter fontSize="inherit" sx={{ mr: "1em" }} />}>
      <Timeline
        sx={{
            ...
            <TimelineContent>
              <Grid container>
                ...
                >
                  ...
                  {w.endDate ? dateFormat(new Date(w.endDate), "mmm yyyy") : "present"}
                </Grid>
              </Grid>
              ...
              {w.relatedProject && (
                <Link to={w.relatedProject}>
                  <Button
                    color="inherit"
                    variant="outlined"
                    sx={{ color: "text.primary", borderColor: "text.primary", my: 2 }}
                  >
                    See in portfolio
                  </Button>
                </Link>
