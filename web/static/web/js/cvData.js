var educationInfo = {
    ...
    elements: [{
        ...
        connection: [{ name: 'National Institute of Physics', href: 'http://nip.upd.edu.ph' }],
...
var trainingInfo = {
    ...
    elements: [{
        ...
        startDate: 'Dec 2019',
        endDate: 'Apr 2020',
        connection: [{ name: 'Division of Continuing Education', href: 'https://www.dce.harvard.edu/' }],
        description: ['CS50W: Web Programming with Python and JavaScript', 'CS50M: Mobile App Development with React Native']
    }]
};
...
var workInfo = {
    ...
    elements: [{
        ...
        startDate: 'Mar 2020',
        endDate: 'present',
        connection: [{ name: 'DetectPH', href: 'https://detectph.com/' }],
        ...
        startDate: 'Jan 2020',
        endDate: 'present',
        connection: [{ name: 'UP Iris', href: 'https://facebook.com/upiris' }],
        ...
        startDate: 'Oct 2017',
        endDate: 'present',
        connection: [{ name: 'Instrumentation Physics Laboratory', href: 'https://sites.google.com/site/instrumentationphysicslab/' }],
        ...
        startDate: 'Jan 2020',
        endDate: 'Feb 2020',
        connection: [{ name: 'Philippine Genome Center', href: 'https://pgc.up.edu.ph/' }],
        ...
        startDate: 'Jun 2019',
        endDate: 'Nov 2019',
        connection: [{ name: 'The Rest is Noise PH', href: 'https://therestisnoiseph.com/' }],
        ...
        startDate: 'Dec 2018',
        endDate: 'Jan 2019',
        connection: [{ name: 'Philippine Coral Reef and Mangrove Remote Sensing Project', href: 'https://202.90.159.82/philcomars/' }],
        ...
        startDate: 'Aug 2018',
        endDate: 'May 2019',
        connection: [{ name: "University of the Philippines Reserve Officers' Training Corps", href: 'https://www.uprotc.org/' }],
...
var projectInfo = {
    ...
    elements: [{
        ...
        startDate: 'Mar 2020',
        endDate: 'present',
        connection: [{ name: 'Project Website', href: 'https://detectph.com/' }],
        ...
        startDate: 'Mar 2020',
        endDate: 'present',
        connection: [{ name: 'Project Website', href: 'https://ncovenience.herokuapp.com/' }],
        ...
        startDate: 'Jan 2020',
        endDate: 'Feb 2020',
        connection: [{ name: 'Project Website', href: 'https://primerdriver.herokuapp.com/' }, { name: 'Download CLI', href: 'https://github.com/kvdomingo/primerdriver/releases' }],
