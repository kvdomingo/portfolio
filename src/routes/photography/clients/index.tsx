  ...
  return (
    <PhotographyLayout>
      <div className="grid grid-cols-1 gap-4 px-6 lg:grid-cols-3 xl:grid-cols-4">
        {clients.map(client => (
          <div key={client.slug} className="card image-full aspect-square w-full shadow-lg group overflow-hidden">
            <figure>
              <img
            ...
            <Link to="/photography/clients/$clientSlug" params={{ clientSlug: client.slug }} className="card-body">
